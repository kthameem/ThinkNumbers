...
public class SubMasterCurrencyPage extends TestBase{
	...
	public SubMasterLedgerPage goToLedgerList() {
		ledgerList.click();
		return new SubMasterLedgerPage();
	}
